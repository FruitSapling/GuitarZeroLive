...
/**
 * A class to generate Guitar button press events. This class polls the Guitar with a while-loop,
 * and when it detects a button press in the Guitar, it generates this event and tells controller to
 * fire an event.
 *
 * @author Willem
 */
public class GuitarPoller implements Runnable {
  ...
  public void run() {
    ...
    if (ctrl == null) {
      // @TODO Create GUI prompt
      System.out.println("Please Connect the Guitar");
