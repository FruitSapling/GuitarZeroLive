/**
 * @author Tom & Mark Refactored for Store Mode from Slash Mode by @Morgan Wrote functionality to
 * get files from server @Mark
 */
...
public class StoreModel {
  ...
  public CarouselButton[] getFilesFromServer(JFrame frame) {
    ...
    Client client = new Client(Constants.SERVER_IP_ADDRESS, Constants.STORE_FILE_PATH,
        Constants.CLIENT_PORT_NUMBER);
