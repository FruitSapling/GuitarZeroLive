...
public class StoreManagerPanel extends JPanel {
  ...
  protected void textBoxes(StoreManagerPanel panel, JTextField tTitle, JTextField tCoverArt,
      JTextField tNotes) {
    // Function generates and positions labels onto the SMM GUI
  ...
  protected JButton generateFileBrowserButton(StoreManagerPanel panel, JTextField field,
      String mode,
  ...
  protected void buttons(StoreManagerPanel panel, JFrame frame, JTextField tTitle,
      JTextField tCoverArt, JTextField tNotes,
      ArrayList<File> files) {
    // Function generates and positions buttons onto the SMM GUI
    JButton titleButton = generateFileBrowserButton(panel, tTitle, "txt", files);
    JButton artButton = generateFileBrowserButton(panel, tCoverArt, "png", files);
    JButton musicButton = generateFileBrowserButton(panel, tNotes, "midi", files);
