 ...
 * @author Mark Newell
 *
 * A basic TCP server that allows multiple clients (game clients) to connect. It then takes commands
 * from the client machines as to when to send the zip folders of songs for the store mode
 */
